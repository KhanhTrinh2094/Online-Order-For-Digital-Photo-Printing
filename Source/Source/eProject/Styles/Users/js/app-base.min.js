...
(function() {
  ...
  Empyre.Theme.CustomerAccounts = (function($) {
    var inform, initHaravanProvinceSelectors, moduleId, notify, showLoginForm, showRecoverPasswordForm;
    moduleId = 'CustomerAccounts';
    inform = Empyre.Services.Inform.get(moduleId);
    notify = Empyre.Theme.Notify;
    initHaravanProvinceSelectors = function() {
      if ($('body.customers-addresses').length) {
        ...
        return $('.address').not('#add_address').each(function() {
          ...
          return new Haravan.CountryProvinceSelector('address_country_' + id, 'address_province_' + id, {
    ...
    $(document).ready(function() {
      if ($('body.customers').length) {
        ...
        return $('.customers-addresses .action-add').click(function(e) {
          e.preventDefault();
          return Haravan.CustomerAddress.toggleNewForm();
        });
      }
    });
    return {
...
(function() {
  ...
  Empyre.Theme.Images = (function($) {
    ...
    getBaseURL = function(imageURL) {
      var size;
      size = Haravan.Image.imageSize(imageURL);
      if (size) {
    ...
    singleProduct = (function() {
      ...
      setPrimaryImage = function(image) {
        ...
        return Haravan.Image.switchImage(image, $primaryImage[0], function(newImageSRC, originalImage, element) {
          var alt, imageIndex;
...
*/
    ...
    updateQtySelect = function(variant) {
      ...
      if (variant) {
        ...
        if (im === 'haravan' && iq > 0 && iq < variantQtySelectMax) {
          qtyMax = iq;
        }
        if (variant.available) {
          i = 1;
...
(function() {
  ...
  Empyre.Theme.ShippingCalculator = (function($) {
    ...
    init = function() {
      ...
      new Haravan.CountryProvinceSelector('sc-address-country', 'sc-address-province', {
